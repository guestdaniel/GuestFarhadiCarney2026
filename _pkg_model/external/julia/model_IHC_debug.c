...
void IHCDEBUG(double *px, double cf, int nrep, double tdres, int totalstim,
        double cohc, double cihc, int species, double *ihcout, double *c1out, double *c1vihcout,
        double *c2out, double *c2vihcout, double *controlout)
{
