function [ihcout, hsrout, lsrout, icout, gain] = sim_efferent_model_ffGn_2014(x, cf, args)
...
if args.noiseType == -1     
    ...
    ffGn_hsr = zeros(n_chan, n_sample);
    for ii=1:n_chan
        ffGn_lsr(ii, :) = ffGn_2014(n_sample, 1/args.fs, 0.9, args.noiseType, 0.1, 3.0);
        ffGn_hsr(ii, :) = ffGn_2014(n_sample, 1/args.fs, 0.9, args.noiseType, 100.0, 200.0);
    end
end
